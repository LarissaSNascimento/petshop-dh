...
const buscarPet =(nomePet) => {
 ...
 console.log(petEncontrado ? petEncontrado :`Nenhum pet encontrado com esse nom ${nomePet}`);
}
...
const listarVacinados = () => {
    ...
    const listarVacinados =() =>{
        console.log('**Vacinado**');
        let vacinados =arquivosPets.pets.filter((pet) =>{
            return pet.vacinado;
        }
    )
